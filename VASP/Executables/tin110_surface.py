...
def main():
	...
	path = '/Users/chtho/Dropbox/Shared/TiN/110/'
	
	# Set up basis and primitive cell
	print '\nSetting up cell...\n'
	a0 = 4.2557
	ti1 = Atom('Ti',array([0.,0.,0.]))
	n1 = Atom('N',array([0.,0.5,0.]))
	ti2 = Atom('Ti',array([0.5,0.5,0.5]))
	n2 = Atom('N',array([0.5,0.,0.5]))
	primitive_cell = PrimitiveCell(array([-0.5,0.5,0.]),array([-0.0,0.0,1.]),array([0.5,0.5,0]))
	...
	#supercell.remove_layer(supercell.get_highest_position())
